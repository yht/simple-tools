...
ln -sf $(pwd)/backup/files-xz.sh $HOME/bin/files-xz
ln -sf $(pwd)/backup/subfolders-tar-xz.sh $HOME/bin/subfolders-tar-xz
ln -sf $(pwd)/docker/docker-pulls.sh $HOME/bin/docker-pulls
